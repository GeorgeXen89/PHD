...
from geometry_analysis import crop_center_section, robust_estimate_diameter, estimate_length
...
def main():
    ...
    diameter, count = robust_estimate_diameter(cropped)
    length = estimate_length(z_min, z_max)
    print(f"➤ Χρήσιμες RANSAC εκτιμήσεις: {count}")
